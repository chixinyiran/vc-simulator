...
const CONFIG = {
  ...
  intro: [
    ...
    { icon:'📖', title:'故事背景',
      body:'从纳斯达克泡沫破裂的2000年出发，穿越门户、Web2.0、移动互联网、O2O风口、硬科技、AI大模型六个时代。每个时代都有造富神话与埋人深坑——你是看懂方向的人，还是浪潮的祭品？' },
    { icon:'⚙️', title:'核心设定',
      body:'<b>6大时代</b>：2000-2026分为门户泡沫→Web2.0→移动互联网→风口狂奔→硬科技突围→AI新纪元。<br><b>5维属性</b>：资本、声望、人脉、运气、健康——没钱投不起，熬垮身体提前出局。<br><b>趋势×运气</b>：项目分顺势/过热/逆势，胜率不同，但运气也掷骰子——同样选择，每局结果都不同。' },
    { icon:'🎯', title:'怎么玩',
