...
const CONFIG = {
  ...
  probability: {
    ...
    perfWeight: { base:0.55, dice:0.45 },
  ...
  ui: {
    ...
    coverRules:    '📜 6大时代 · 24次抉择 · 押注当下不揭晓<br>每个时代结束，命运统一揭晓<br>顺势·过热·逆势，胜率不同，运气也算数<br>钱不够投不起大项目，熬垮身体提前出局',
    coverCredit:   '🦞 小龙虾 出品 · 仅供娱乐<br>剧情与项目均为虚构，如有雷同纯属巧合',
    btnStart:      '开始新游戏',
    btnContinue:   '⏎ 继续上次',
    btnViewLast:   '📊 查看上次战绩',
    btnRestart:    '重新开始新游戏',
    confirmRestart:'确定放弃上次的存档，重新开始吗？',
  ...
  intro: [
    { icon:'🎮', title:'这是什么游戏',
      body:'一款关于「选择、运气与时代」的文字叙事经营游戏。你将扮演一名投资人，从2000年互联网泡沫破裂的废墟起步，亲历中国创投二十六年的惊涛骇浪——每一次出手，都是一次对时代的下注。' },
    { icon:'📖', title:'故事背景',
      body:'2000年，纳斯达克泡沫破裂，你从大学计算机系毕业，机缘巧合踏入当时还无比小众的创投圈。此后二十六年，你将穿越门户网站、Web2.0、移动互联网、O2O风口、硬科技、AI大模型……每一个时代都有它的造富神话与埋人深坑。你能看懂时代的方向，还是会成为浪潮的祭品？' },
    { icon:'⚙️', title:'核心设定',
      body:'<b>6大时代</b>：2000-2026划分为门户泡沫→Web2.0→移动互联网→风口狂奔→硬科技监管→AI新纪元六个阶段。<br><b>5维属性</b>：资本(AUM)、业绩声望、人脉、运气、健康——钱不够投不起大项目，熬垮身体会提前出局。<br><b>趋势与运气</b>：项目分顺势📈/过热🔥/逆势📉，胜率天差地别，但运气也参与骰子——同样的选择，每局结果都不同。' },
    { icon:'🎯', title:'怎么玩',
      body:'每个时代有3-5次投资机会，每次从3个项目里押注1个。<br><b>关键设定——延迟揭晓</b>：押注后不会立刻告诉你结果，而是等整个时代落幕，命运一次性揭晓(就像真实投资要等很多年才见分晓)。<br>看懂时代趋势、管好资本和健康，是穿越周期的关键。' },
    { icon:'🏆', title:'你会得到什么',
      body:'走完二十六年，你将收获两张专属标签：<br><b>① 投资结局称号</b>——从「封神级·时代造王者」到「离场的勇者」，共7档，由你的最终战绩决定。<br><b>② 投资风格画像</b>——稳健/激进 × 理性/感性，测出你是「精算守门人」「热血弄潮儿」还是「平衡掌舵者」。<br>结果可生成精美战绩长图，分享给朋友比拼谁是更强的投资人。' },
    { icon:'💾', title:'贴心功能',
      body:'• 中途退出自动存档，下次打开能接着玩<br>• 玩完可随时回看上次战绩<br>• 记录历史最高分和最常风格<br>• 6个时代各配专属背景音乐，可随时开关' },
  ],
};
